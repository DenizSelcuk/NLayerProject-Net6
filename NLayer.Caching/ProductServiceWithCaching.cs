...
{
    //Caching'e en iyi aday, çok sık güncellemediğimiz, ancak çok sık eriştiğimiz datalardır.
    public class ProductServiceWithCaching : IProductService
    {
        ...
        public async Task CacheAllProductsAsync() //Her çağrıldığında datayı çekip caching yapar
        {
